		...
		shortcuts: [
			{
				...
				description:
					'Navigate the digital landscape of Waffle Hack with ease. Discover our commitment to accessibility.',
				icons: [
					{
			...
			},
			{
				...
				url: '/legal/terms',
				description:
					"The fine print of our digital handshake. Understand Waffle Hack's Terms of Service.",
				icons: [
					{
						src: '/assets/svgs/logo-icon.svg',
						type: 'image/svg+xml',
			...
			},
			{
				...
				url: '/legal/privacy',
				description:
					'Your privacy matters to us. Learn how Waffle Hack protects your personal information.',
				icons: [
					{
						src: '/assets/svgs/logo-icon.svg',
						type: 'image/svg+xml',
			...
			},
			{
				...
				url: '/legal/rules',
				description:
					"The do's and don'ts of Waffle Hack. Explore the rules that keep our community safe and respectful.",
				icons: [
					{
						src: '/assets/svgs/logo-icon.svg',
						type: 'image/svg+xml',
