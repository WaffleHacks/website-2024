	...
	return (
		<>
			<header
				...
				text-[#3C2415] mt-10 h-14
			`}
			>
				Website Accessibility Policy
			</header>
			<Container component={`article`} sx={{ my: 3, color: '#3c2415' }} maxWidth={`sm`}>
				...
				<Typography gutterBottom>
					...
					accessible to all individuals, including those with disabilities. We strive to ensure that
					our website complies with the Web Content Accessibility Guidelines{' '}
					<Link
				...
				<Typography gutterBottom>
					We have invested a significant amount of resources to help ensure that its website is made
					easier to use and more accessible for people with disabilities, with the strong belief
					that every person has the right to live with dignity, equality, comfort and independence.
				</Typography>
				<Typography gutterBottom>
				...
				<Typography>
					While we are committed to making our website accessible, we understand that not all areas
					of our website may be{' '}
				...
				<Typography gutterBottom>
					We will do our best to address any issues and answer any questions. Thank you for visiting
					our website!
				</Typography>
				<Typography gutterBottom>This policy was last updated on 26 December 2023.</Typography>
			</Container>
		</>
	);
};
