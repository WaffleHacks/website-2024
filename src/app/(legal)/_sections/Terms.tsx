		...
		<>
			...
			<Container maxWidth="sm" sx={{ marginTop: 3, marginBottom: 3 }} component={`article`}>
				...
				>
					...
					<Link className={`underline`} href={app.url}>
						{app.url}
					</Link>{' '}
				...
				>
					...
					using or accessing this website or using any other services provided by {app.name}.
				</Typography>
				<Typography
					sx={{
						color: '#3C2415',
					...
					gutterBottom
				>
					We, {app.name}, reserve the right to review and amend any of these Terms of Service at our
				...
				>
					...
					<li>
						...
						that abuses or disrupts our networks or any other service {app.name} provides;
					</li>
					<li>
				...
				>
					...
					licensed to {app.name} and are protected by applicable copyright and trademark law. We
				...
				>
					...
					and may be terminated by {app.name}
					at any time.
				</Typography>
				<Typography
					sx={{
				...
				<Typography
					...
					gutterBottom
				>
					Our website and the materials on our website are provided on an &lsquo;as is&rsquo; basis.
					To the extent permitted by law, {app.name} makes no warranties, expressed or implied, and
				...
				<Typography
					...
					gutterBottom
				>
					In no event shall {app.name} or its suppliers be liable for any consequential loss
					suffered or incurred by you or any third party arising from the use or inability to use
					this website or the materials on this website, even if {app.name} or an authorized
				...
				>
					...
					information purposes only. {app.name} does not warrant or make any representations
				...
				<Typography
					...
					gutterBottom
				>
					{app.name} has not reviewed all of the sites linked to its website and is not responsible
					for the contents of any such linked site. The inclusion of any link does not imply
					endorsement, approval, or control by
					{app.name} of the site. Use of any such linked site is at your own risk and we strongly
				...
				<Typography
					...
					gutterBottom
				>
					These Terms of Service are governed by and construed in accordance with the laws of United
					States. You irrevocably submit to the exclusive jurisdiction of the courts in that State
					or location.
				</Typography>
			</Container>
		</>
