	...
	return (
		<>
			...
			>
				...
				<Typography gutterBottom>
					We, {app.name}, reserve the right to review and amend any of these
				...
				<Typography gutterBottom>
					...
					are owned by or licensed to {app.name} and are protected by applicable
				...
				<Typography gutterBottom>
					...
					on this website, even if {app.name} or an authorized representative
				...
				<Typography gutterBottom>
					...
					for general information purposes only. {app.name} does not warrant or
				...
				<Typography gutterBottom>
					...
					by
					{app.name} of the site. Use of any such linked site is at your own
