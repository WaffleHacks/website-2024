...
export const Privacy = () => {
	return (
		<>
			...
			<Container sx={{ my: 20 }} maxWidth="sm" component={`article`}>
				<Typography gutterBottom>
					Your privacy is important to us. It is {app.name}&#39; policy to respect your privacy and
					comply with any applicable law and regulation regarding any personal information we may
					collect about you, including across our website, <Link href={app.url}>{app.url}</Link>,
					and other sites we own and operate.
				</Typography>
				<Typography gutterBottom>
					This policy is effective as of 28 February 2021 and was last updated on 28 February 2021.
				</Typography>
				...
				<Typography gutterBottom>We may disclose personal information to: </Typography>
				<ul>
				...
				<Typography gutterBottom>
					...
					accesses each time you visit, so we can understand how you use our site. This helps us
				...
				<Typography gutterBottom>
					{app.name} Support Team (<Link href={`mailto:${app.email}`}>{app.email}</Link>)
				</Typography>
			</Container>
		</>
	);
