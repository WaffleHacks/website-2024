		...
		<>
			...
			>
				...
				<Typography component="ol" gutterBottom>
					...
					<li>
						Teams are welcome to solicit gain advice and support from
					...
					<li>
						...
						they are allowed to do so and will be judged on the quality of their
						hack. Truly original ideas are hard to find and teams might not know
						an idea has been done before anyway.
					</li>
					<li>
					...
					<li>
						...
						for the sole purpose of using the code during the event is against
						the spirit of the rules and is not allowed.
					</li>
					<li>
					...
					<li>
						...
						your application and the fix is only a few lines of code, it's okay
						to fix that. Making large changes or adding new features is not
						allowed.
					</li>
					...
					<li>
						...
						the Rules of the Competition, or other unsporting behavior.
					</li>
					<li>
						To receive any awarded prizes and/or swag, you must have submitted
						an application, and been accepted, in the{" "}
				...
				<Typography gutterBottom>
					After hacking finishes, teams will show their projects to each other
					and to the judges by submitting on{" "}
				...
				<Typography gutterBottom>
					...
					quality of your pitch or the quality of your idea. As you are judged
					on what you built, you'll only hurt yourself by not showing a demo.
				</Typography>
				<Typography gutterBottom>
					...
					your hack—that happens all the time! Completion is only one part of
					the judging criteria, so you might still do well. Also, demoing is not
					just about the competition. It's a chance to share with others what
					you learned and what you tried to build—that's what hacking's all
					about! In the case that you don't have anything to demo, you can give
					a presentation about what you tried and what you learned.
				</Typography>
				...
				<Typography component="ul" gutterBottom>
					...
					<li>
						...
						<Typography component="ul">
							...
							<li>
								Can your project scale to meet the requirements of mass
								adoption?
							</li>
						</Typography>
					</li>
				...
				<Typography gutterBottom>
					These criteria will guide judges but ultimately judges are free to
					make decisions based on their gut feeling of which projects are the
					most impressive and most deserving.
				</Typography>
				<Typography gutterBottom>
				...
				<Typography component="ul" gutterBottom>
					<li>
						How good your code is. It doesn't matter if your code is messy, or
						not well commented, or uses inefficient algorithms. Hacking is about
						playing around, making mistakes, and learning new things. If your
						code isn't production ready, we're not going to mark you down.
					</li>
					<li>
						How well you pitch. Hacking is about building and learning, not
						about selling.
					</li>
					<li>
				...
				<Typography gutterBottom>
					...
					might lead to the next big thing—but you don't have to do that to win
					a hackathon.
				</Typography>
				...
				<Typography gutterBottom>
					The competition is just a part of the hackathon. To make the most out
					of the event, try something new, teach other people, and make new
					friends!
				</Typography>
