			...
			<Container maxWidth="sm" sx={{ marginTop: 3, marginBottom: 3 }} component={`article`}>
				...
				>
					<li>
						...
						the day of the event. You are also free to work on your own.
					</li>
					<li>
						Teams should be made up exclusively of high school or undergraduate students who are not
						organizers, volunteers, judges, sponsors, or in any other privileged position at the
						event.
					</li>
					<li>
						All team members should be present at the event and in communication with the rest of
						the team.
					</li>
					<li>
						Teams are welcome to solicit gain advice and support from organizers, volunteers,
						sponsors, and others.
					</li>
					<li>All work on a project should be done at the hackathon.</li>
					<li>Teams can use an idea they had before the event.</li>
					<li>
						Teams can work on ideas that have already been done. Hacks do not have to be
						“innovative”. If a team wants to work on a common idea they are allowed to do so and
						will be judged on the quality of their hack. Truly original ideas are hard to find and
						teams might not know an idea has been done before anyway.
					</li>
					<li>
						Teams can work on an idea that they have worked on before provided they do not re-use
						code or other project materials.
					</li>
					<li>
						Teams can use libraries, frameworks, or open-source code in their projects. Working on a
						project before the event and open-sourcing it for the sole purpose of using the code
						during the event is against the spirit of the rules and is not allowed.
					</li>
					<li>
						Adding new features to existing projects is allowed. Judges will only consider new
						functionality introduced or new features added during the hackathon in determining the
						winners.
					</li>
					<li>
						Teams must stop hacking once the time is up. However, teams are allowed to debug and
						make small fixes to their programs after time is up. e.g. If during demoing your hack
						you find a bug that breaks your application and the fix is only a few lines of code,
						it's okay to fix that. Making large changes or adding new features is not allowed.
					</li>
					<li>Projects that violate the aforementioned are not allowed.</li>
					<li>
						Teams can be disqualified from the competition at the organizers' discretion. Reasons
						might include but are not limited to breaking the Rules of the Competition, or other
						unsporting behavior.
					</li>
					<li>
						To receive any awarded prizes and/or swag, you must have submitted an application, and
				...
				>
					...
					Also, demoing is not just about the competition. It's a chance to share with others what
					you learned and what you tried to build—that's what hacking's all about! In the case that
					you don't have anything to demo, you can give a presentation about what you tried and what
					you learned.
				</Typography>
				...
				>
					...
					<li>
						...
						>
							...
							<li>
								For a hardware project, it might be more about how good the human-computer
								interaction is.
							</li>
					...
					<li>
						...
						>
							...
							<li>
								This category will be based solely on the idea behind your project, regardless of
								functionality
							</li>
						</Typography>
					</li>
				...
				>
					<li>
						...
						learning new things. If your code isn't production ready, we're not going to mark you
						down.
					</li>
					<li>How well you pitch. Hacking is about building and learning, not about selling.</li>
					<li>
						How good the idea is. Again, hackathons aren't about coming up with innovative ideas.
				...
				>
					...
					you make might lead to the next big thing—but you don't have to do that to win a
					hackathon.
				</Typography>
