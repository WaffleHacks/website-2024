...
export const TeamCard: React.FC<{ member: TeamMemberData; style?: CSSProperties }> = ({
	member,
	style,
}) => {
	...
	return (
		...
		>
				...
				<g clip-path="url(#clip0_876_1231)">
					...
					<g filter="url(#filter1_d_876_1231)">
						...
						<path
							fill-rule="evenodd"
							clip-rule="evenodd"
							d="M69 854C57.9543 854 49 845.046 49 834V395C49 383.954 57.9543 375 69 375H650C661.046 375 670 383.954 670 395V427H455.5C418.221 427 388 457.221 388 494.5C388 531.779 418.221 562 455.5 562H670V834C670 845.046 661.046 854 650 854H69Z"
							fill={member.color}
						/>
					</g>
					...
					<g opacity="0.8" filter="url(#filter2_f_876_1231)">
						<rect
							...
							height="58"
							rx="18"
							fill="url(#paint1_linear_876_1231)"
						/>
					</g>
					{/* name bar */}
					...
					<g filter="url(#filter3_d_876_1231)">
						<path
							d="M130 85H589"
							stroke="url(#paint2_linear_876_1231)"
					...
					{/* medal */}
					<path
						d="M398.838 279.804C399.178 279.39 398.884 278.767 398.348 278.767H391.653C391.461 278.767 391.279 278.854 391.158 279.004L384.022 287.887C383.688 288.302 383.984 288.919 384.517 288.919H391.049C391.239 288.919 391.419 288.834 391.539 288.687L398.838 279.804Z"
						fill="#B73F48"
					/>
					<path
						d="M375.162 279.804C374.822 279.39 375.116 278.767 375.652 278.767H382.347C382.539 278.767 382.721 278.854 382.842 279.004L389.978 287.887C390.312 288.302 390.016 288.919 389.483 288.919H382.951C382.761 288.919 382.581 288.834 382.461 288.687L375.162 279.804Z"
						fill="#FB071A"
					/>
					<path
						d="M387.317 305.733C392.924 305.733 397.469 301.188 397.469 295.581C397.469 289.974 392.924 285.429 387.317 285.429C381.71 285.429 377.165 289.974 377.165 295.581C377.165 301.188 381.71 305.733 387.317 305.733Z"
						fill="#FDDC79"
						stroke="#FBAD24"
					/>
					...
					<g filter="url(#filter4_d_876_1231)">
						<path
							d="M390.751 295.118L387.752 292.119C387.504 291.872 387.102 291.872 386.855 292.119L383.856 295.118C383.608 295.366 383.608 295.768 383.856 296.016L386.855 299.015C387.102 299.263 387.504 299.263 387.752 299.015L390.751 296.016C390.999 295.768 390.999 295.366 390.751 295.118Z"
							fill="#FFEFBC"
							fill-opacity="0.95"
						/>
					</g>
			...
			<defs>
				...
				>
					...
					<feMorphology
						...
						operator="dilate"
						in="SourceAlpha"
						result="effect1_dropShadow_876_1231"
					/>
					<feOffset dx="3" dy="10" />
					...
					<feBlend
						mode="normal"
						in="SourceGraphic"
						in2="effect1_dropShadow_876_1231"
						result="shape"
					/>
				</filter>
				{/* drap shadow under bottom section */}
				<filter
					id="filter1_d_876_1231"
					x="7"
					y="334"
					width="705"
					height="563"
				...
				>
					...
					<feColorMatrix
						type="matrix"
						values="0 0 0 0 0.615686 0 0 0 0 0.407843 0 0 0 0 0.196078 0 0 0 1 0"
					/>
					<feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_876_1231" />
					<feBlend
						mode="normal"
				...
				>
					...
					<feColorMatrix
						type="matrix"
						values="0 0 0 0 0.533765 0 0 0 0 0.493901 0 0 0 0 0.37431 0 0 0 0.4 0"
					/>
					<feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_876_1231" />
					<feBlend
						mode="normal"
			...
			{/* team */}
			<text x="415" y="250" fill="#604020" style={{ font: 'normal 18px sans-serif' }}>
				Team Waffle {member.waffle_team}
			</text>
			{/* years at wafflehacks */}
			<text x="415" y="300" fill="#604020" style={{ font: 'normal 18px sans-serif' }}>
				{member.member_since}x {team} {member.position}
			</text>
			{/* looking forward to */}
			<text x="94" y="458" style={{ font: 'bold 26px sans-serif' }} fill="#3C2415">
				Looking Forward to...
			</text>
			...
			{splitIntoLines('"' + member.looking_forward + '"', 30).map((line, index) => {
				return (
					<text
						...
						y={490 + 25 * index}
						fill="#3C2415"
						style={{ font: 'normal 18px sans-serif' }}
					>
						{line}
					</text>
				);
			...
			<text x="400" y="645" fill="#3C2415" style={{ font: 'bold 18px sans-serif' }}>
				Favorite Olympic Sport
			</text>
			<image
				width="170"
				...
				x="410"
				y="670"
				href={`/assets/svgs/team/${member.photo_name}.svg`}
			></image>
			...
			{splitIntoLines(member.education.school, 25).map((line, index, arr) => {
				return (
					<text
						x="130"
						y={662 - 12.5 * (arr.length - 1) + 25 * index}
						fill="#604020"
						style={{ font: 'normal 20px sans-serif' }}
					>
						{line}
					</text>
				);
			...
			{/* class of [year] */}
			<text x="130" y="728" fill="#604020" style={{ font: 'normal 20px sans-serif' }}>
				Class of {member.education.class}
			</text>
			...
			{splitIntoLines(member.education.major, 25).map((line, index, arr) => {
				return (
					<text
						x="130"
						y={800 - 12.5 * (arr.length - 1) + 25 * index}
						fill="#604020"
						style={{ font: 'normal 20px sans-serif' }}
					>
						{line}
