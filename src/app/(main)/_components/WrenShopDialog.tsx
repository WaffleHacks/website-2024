...
const WrenShopDialog = () => {
  ...
  return (
    <div className={'w-full h-full flex justify-center items-center' + (completed ? ' bg-orange-100' : '')}>
...

        {
            ...
            >
                <div className='p-4'>
                    {
                        ctx.completed ? <>
                        <span>Hey homie, you already got your waffle! <br />Wanna look at it again?</span>
                        <br /><br />
                        <button 
                ...
                <div className='p-4'>
                    <p>You need a ticket to get a waffle.
                    I told the WaffleHacks Games committee to give everyone one ticket for a waffle.
                    Yours should hopefully be around somewhere. Maybe you need to search for it?</p>
                    <br />
                    <button 
                        className='bg-gray-300 rounded-md px-2 py-px'
                        onClick={() => {
...

        {
            ...
            <div className='absolute right-4 bottom-4 text-xl'>
                <span>
                    {ctx.completedTime.getUTCMonth() + 1}/{ctx.completedTime.getUTCDate()}/{ctx.completedTime.getUTCFullYear()}{' '}
                    {ctx.completedTime.getUTCHours()}:{ctx.completedTime.getUTCMinutes()}:{ctx.completedTime.getUTCSeconds()} UTC
                </span>
            </div>
