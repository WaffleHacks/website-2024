	...
	const events: EventList[] = [
		{
			...
			Panels: [
				...
				null,
				{
					...
					link: 'https://meet.google.com/oip-wiwi-kxb',
					type: CDT.CAREER,
				},
				null,
				null,
		...
		},
		{
			...
			Workshops: [
				...
				null,
				{
					...
					link: 'https://meet.google.com/hdj-gabf-fxs',
					type: CDT.TECHNICAL,
				},
				null,
				{
					title: 'Intro to Mobile Development with Mike Odnis',
					description: '',
				...
				{
					title: 'Intermediate Application Development with Google Cloud with Mike Odnis',
					description: '',
					time: '5:00 PM - 6:00 PM',
				...
				null,
				{
					title: 'Intro to Cloud Computing with Devin Lin',
					description: 'Welcome to WaffleHacks 2023!',
			...
			Panels: [
				{
					title: 'Resume Workshop with Kevin Liao',
					description: '',
		...
		},
		{
			Ceremonies: [
				...
				null,
				{
					...
					time: '5:00 PM',
					link: 'https://www.youtube.com/live/LQh4poD3XzE',
					type: CDT.CEREMONY,
				},
				null,
				null,
			...
			Workshops: [
				{
					title: 'Hackathon Portfolio Pipeline',
					description: '',
					time: '12:30 PM - 2:00 PM',
					link: 'https://meet.google.com/gtu-ndsr-xse',
					type: CDT.CAREER,
				},
				{
					title: 'Alternative CS Paths',
					description: '',
					time: '2:00 PM - 3:00 PM',
					link: 'https://meet.google.com/xwa-cced-gkp',
					type: CDT.CAREER,
				},
				{
					...
					link: 'https://meet.google.com/yoi-sdop-psf',
					type: CDT.CAREER,
				},
				{
					title: 'Judging',
