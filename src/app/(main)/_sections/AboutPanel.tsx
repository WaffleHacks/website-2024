		...
		<>
			<article
				className={cn(`
					...
					w-full max-w-screen-lg max-h-160 bg-white bg-opacity-40 shadow-md rounded-xl border border-white border-opacity-10`)}
			>
				<Card
					className={`
            flex flex-col justify-between shadow-xl
            back drop-blur-lg p-8 rounded-xl
          ...
          `}
				>
					...
					<CardBody className="flex flex-col justify-between gap-2">
						<Text
							className={`
								text-xl font-semibold text-left text-black 
							`}
							text={[
