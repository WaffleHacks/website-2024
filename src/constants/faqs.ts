...
}> = [
	{
		...
		items: [
			...
			},
			{
				...
				description: "The theme of this hackathon is 'Innovation in Technology'.",
			},
			{
			...
			},
			{
				...
				description: 'The rules of the hackathon are available on the rules page on our website.',
			},
		],
	},
	{
